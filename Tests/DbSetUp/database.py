...
ecksso25 = urllib.parse.quote_plus('DRIVER={SQL Server Native Client 11.0};'
                                 ...
                                 'UID=wbpoc;'
                                 'PWD=sql@tfs2008;')
DFLocal = urllib.parse.quote_plus('DRIVER={SQL Server Native Client 11.0};'
                                 'SERVER=L-R90X454T.corpadds.com;'
                                 'DATABASE=DFLocal;'
                                 'UID=wbpoc;'
                                 'PWD=sql@tfs2008;')

connect_args = {'autocommit': True}
engine = create_engine('mssql+pyodbc:///?odbc_connect={}'.format(DFLocal), connect_args=connect_args)
